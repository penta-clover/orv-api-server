...
import com.orv.api.domain.reservation.dto.SceneInfo;
...
class InterviewScenarioFactoryTest {
    ...
    void setUp() {
        ...
        interviewScenarioFactory = new InterviewScenarioFactory(objectMapper);
    }
