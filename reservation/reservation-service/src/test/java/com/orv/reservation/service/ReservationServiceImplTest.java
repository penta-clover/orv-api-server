...
import com.orv.reservation.service.InterviewReservationServiceImpl;
...
public class ReservationServiceImplTest {
    ...
    public void testMarkInterviewAsDone() {
        // given
        UUID interviewId = UUID.randomUUID();
        when(interviewReservationRepository.changeInterviewReservationStatus(eq(interviewId), eq(ReservationStatus.DONE)))
                .thenReturn(true);
